    ...
    create: function (context) {
        return {
                    ...
                    fix(fixer) {
                        return [
                            ...
                            fixer.replaceText(
                                ...
                                `${node.arguments[0].raw}, expect.string${node.parent.parent.property.name.slice(2)}ing(${node.parent.parent.parent.arguments[0].raw})`
                            ),
                        ];
                    },
                });
            ...
            [`CallExpression[callee.property.name='getAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBe$|to(Strict)?Equal/]`](
                ...
                const isNullOrEmpty = arg.length > 0 && (arg[0].value === null || arg[0].value === '');
                ...
                context.report({
                    ...
                    fix(fixer) {
                        ...
                        return [
                            fixer.removeRange([node.callee.object.end, node.end]),
                            fixer.replaceText(node.parent.parent.property, `${isNullOrEmpty ? 'not.' : ''}toHaveAttribute`),
                            lastFixer,
                        ];
                    },
                });
            ...
            [`CallExpression[callee.property.name='hasAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBeNull|toBeUndefined|toBeDefined/]`](
                ...
                context.report({ node: node.parent.parent.property, message: "Invalid matcher for hasAttribute" })
            ...
            [`CallExpression[callee.property.name='getAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBeUndefined|toBeDefined/]`](
                ...
                context.report({ node: node.parent.parent.property, message: "Invalid matcher for getAttribute" })
                    ...
                    fix(fixer) {
                        return [
                            ...
                            fixer.replaceTextRange(
                                ...
                                `${node.parent.parent.property.name === 'toBeFalsy' ? 'not.' : ''}toHaveAttribute(${node.arguments[0].raw})`
                            ),
                        ];
                    },
                });
